...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name="Starlight Romero").one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, "Starlight Romero")
        self.assertEqual(created_author.biography, "This is a biography.")
